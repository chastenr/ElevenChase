...
export const metadata: Metadata = { title: "Process", description: "How ElevenChase turns business problems into production software.", alternates: englishAlternates("/process") };
